...
#pragma warning disable S2223 // Non-constant static fields should not be visible
	internal static Guid GUID_ACDC_POWER_SOURCE = new(0x5D3E9A59, 0xE9D5, 0x4B00, 0xA6, 0xBD, 0xFF, 0x34, 0xFF, 0x51, 0x65, 0x48);
	internal static Guid GUID_BATTERY_PERCENTAGE_REMAINING = new("A7AD8041-B45A-4CAE-87A3-EECBB468A9E1");
#pragma warning restore S2223 // Non-constant static fields should not be visible

	internal delegate int ServiceControlHandlerEx(
		int control,
		int eventType,
		IntPtr eventData,
		IntPtr context
	...
	[SuppressMessage(
		...
		Justification = "Externally defined in winuser.h"
	)]
